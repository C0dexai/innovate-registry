...
export const CrosshairIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path d="M12 8V4m0 16v-4m8-4h-4M4 12H8" />
...
export const GeminiIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2L9.88 7.33 4 8.24l4.51 3.9L7.33 18.12 12 15.33l4.67 2.79-1.18-5.98L20 8.24l-5.88-.91L12 2zm0 4.23L13.25 9.1l2.8.43-2.14 1.86.6 2.8-2.51-1.5-2.51 1.5.6-2.8-2.14-1.86 2.8-.43L12 6.23z" />
    </svg>
);

export const OpenAIIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2L20.5 7v10L12 22 3.5 17V7L12 2z" />
    </svg>
);